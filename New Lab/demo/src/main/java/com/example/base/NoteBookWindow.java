...
import com.example.base.Folder;
import com.example.base.Note;
import com.example.base.NoteBook;
import com.example.base.TextNote;
...
public class NoteBookWindow extends Application {
	...
	private VBox addVBox() {
		...
		noteBook.getFolders().forEach(f -> foldersComboBox.getItems().add(f.getName()));
	...
	private void updateListView() {
		...
		for(Folder f : noteBook.getFolders()){
			if(f.getName()==currentFolder){
				f.getNotes().forEach(n -> list.add(n.getTitle()));
			}
		}
